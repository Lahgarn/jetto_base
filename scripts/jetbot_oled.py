...
from jetto_base.battery import ina219
...
if __name__ == '__main__':
    ...
    while not rospy.core.is_shutdown():
        ...
        draw.text((x, top+8),"Bus Voltage:", font=font, fill=255)
        draw.text((x, top+16), "{:9.6f} V".format(bus_voltage + shunt_voltage),  font=font, fill=255)
